...
import KnowledgeTabs from "../KnowledgeTabs"; // đường dẫn từ /all quay lên
...
async function fetchPosts() {
  // ✅ Đổi status=published -> published=true (khớp backend)
  return api<any>("/api/posts?category=knowledge&published=true", {
    method: "GET",
  });
}
